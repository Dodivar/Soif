  ...
  <v-container class="text-center text-white">
    ...
    <v-menu open-on-hover>
      ...
      <v-sheet elevation="10">
        <ul>
          <li>
            Le premier joueur annonce : « je pars en voyage et je mets dans ma valise… un pyjama »
          </li>
          <li>
            Le joueur suivant répète cette phrase et ajoute autre chose, par exemple : « je pars en
            voyage et je mets dans ma valise… un pyjama et une robe »
          </li>
          <li>
            Chacun à leur tour, les joueurs répètent la phrase depuis le début dans l'ordre, en
            ajoutant à chaque fois quelque chose.
          </li>
